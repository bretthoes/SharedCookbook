...
namespace SharedCookbook.Infrastructure.UnitTests.Configuration;

public class WhenWebAppSettingsLoaded
{
  private static IConfiguration Configuration { get; } = new ConfigurationBuilder()
    .AddJsonFile(AppSettingsPaths.ResolveFromRepositoryRoot(AppSettingsPaths.WebAppSettingsRelativePath))
    .Build();
