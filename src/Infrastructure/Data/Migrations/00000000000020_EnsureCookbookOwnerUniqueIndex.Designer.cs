...
namespace SharedCookbook.Infrastructure.Data.Migrations
{
    ...
    [Migration("00000000000020_EnsureCookbookOwnerUniqueIndex")]
    partial class EnsureCookbookOwnerUniqueIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SharedCookbook.Domain.Entities.CookbookMembership", b =>
                {
                    ...
                    b.HasIndex(new[] { "CookbookId" }, "UX_cookbook_member__cookbook_owner")
                        .IsUnique()
                        .HasFilter("tier = 3");
