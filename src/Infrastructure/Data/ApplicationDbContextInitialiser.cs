...
public class ApplicationDbContextInitialiser
{
    ...
    private async Task TrySeedAsync()
    {
        ...
        var otherAdmin = await _userManager.Users.FirstOrDefaultAsync(x => x.Email == "test@test.com");
        var otherAdminId = otherAdmin?.Id;
        var cookbooks = new List<Cookbook>
        {
            ...
            new() { Title = "Not My Cookbook", Image = null, CreatedBy = otherAdminId, },
        };
        ...
        {
            new() { Name = "ad3bef7c-1d4f-46f2-839d-0c01a5e0c33e.png", RecipeId = recipe!.Id, Ordinal = 1 },
            new() { Name = "ad3bef7c-1d4f-46f2-839d-0c01a5e0c33d.png", RecipeId = recipe!.Id, Ordinal = 2 }
        };
        ...
        var ingredients = new List<RecipeIngredient>()
        {
            new()
            {
                RecipeId = recipe!.Id, Name = "1 can salmon", Ordinal = 1, Optional = false,
            },
            new()
            {
                RecipeId = recipe!.Id, Name = "1/2 cup crushed saltine crackers", Ordinal = 2, Optional = false,
            },
            new()
            {
                RecipeId = recipe!.Id, Name = "1/2 cup milk", Ordinal = 3, Optional = false,
            },
            new()
            {
                RecipeId = recipe!.Id, Name = "1 large egg, beaten", Ordinal = 4, Optional = false,
            },
            new()
            {
                RecipeId = recipe!.Id, Name = "2 tablespoons melted butter", Ordinal = 5, Optional = false,
            },
            new()
            {
                RecipeId = recipe!.Id, Name = "salt and pepper to taste", Ordinal = 6, Optional = true,
            }
        };
